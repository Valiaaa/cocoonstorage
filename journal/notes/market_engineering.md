...
## role & responsibility
Market engineers are people who can <b>build agents</b> and<b> automations</b> that run campaigns.
...
- draft outreach
- track every competitor move and grade its severity
- update marketing strategy
- turn webinar into a brand-voice article
...
- <span class="list-item-spaced"><b>monitor media coverage</b> building and maintaining <b>component libraries</b> for both designer spec and engineer implementation.</span>
- <span class="list-item-spaced"><b>flag sentiment shifts</b> create high-fidelity, interactive prototypes for testing before full implementation on engineer's side.</span>
- <span class="list-item-spaced"><b>draft outreach</b> build internal tools based on teams needs. Eg. documentation, plugins, etc.</span> -->

<br>

<div class="video-note">[ source, reference, & extended reading ]</div>

1. <a href="https://x.com/dbabbs/status/2044087231258783940?s=20" target="_blank">The Marketing Engineer is... @Dylan Babbs</a>
...
4. <a href="https://github.com/gitroomhq/postiz-app" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--text-color)" viewBox="0 0 256 256"><path d="M58.34,101.66l-32-32a8,8,0,0,1,0-11.32l32-32A8,8,0,0,1,69.66,37.66L43.31,64,69.66,90.34a8,8,0,0,1-11.32,11.32Zm40,0a8,8,0,0,0,11.32,0l32-32a8,8,0,0,0,0-11.32l-32-32A8,8,0,0,0,98.34,37.66L124.69,64,98.34,90.34A8,8,0,0,0,98.34,101.66ZM200,40H176a8,8,0,0,0,0,16h24V200H56V136a8,8,0,0,0-16,0v64a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40Z"></path></svg>Open-source AI social media scheduling tool</a>: watch the video first and check the folder structure.

5. <a href="https://zephyr-hq.com/news-to-content-flow?utm_source=zephyr-hq.com&utm_medium=newsletter&utm_campaign=your-free-gift-is-ready-start-here" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="var(--text-color)" viewBox="0 0 256 256"><path d="M232,168h-8V72a24,24,0,0,0-24-24H56A24,24,0,0,0,32,72v96H24a8,8,0,0,0-8,8v16a24,24,0,0,0,24,24H216a24,24,0,0,0,24-24V176A8,8,0,0,0,232,168ZM48,72a8,8,0,0,1,8-8H200a8,8,0,0,1,8,8v96H48ZM224,192a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8v-8H224ZM152,88a8,8,0,0,1-8,8H112a8,8,0,0,1,0-16h32A8,8,0,0,1,152,88Z"></path></svg>News to content flow</a>: the website contains more free resource.